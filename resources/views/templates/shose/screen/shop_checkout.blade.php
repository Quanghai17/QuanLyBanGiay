...
<section class="section section-xl bg-default text-md-left">
                ...
                <div class="col-12">
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <h3 class="breadcrumb-title">Kiểm Tra</h3>
    ...
    <div class="container" style="margin-top: 50px">
        <div class="row">
            @if (count($cartItem) ==0)
            <div class="col-md-12 text-danger min-height-37vh" style="margin-top: 70px">
                        ...
                        <div class="row" style="padding-bottom: 20px;">
                            <div class="col-md-12 text-center">
                                <div class="pull-right">
                                    {!! $viewCaptcha ?? ''!!}
                                    <button class="news-btn" style="margin-bottom: 30px" type="submit" id="button-form-process">{{ sc_language_render('cart.checkout') }}</button>
                                </div>
                            </div>
                        </div>
                        {{-- Button checkout --}}
