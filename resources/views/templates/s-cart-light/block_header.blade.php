                          ...
                          <div class="rd-navbar-panel">
                              ...
                              <div class="rd-navbar-brand">
                                  <!--Brand--><a class="brand" href="{{ sc_route('home') }}"><img
                                          ...
                                          src="{{ sc_file(sc_store('logo', $storeId ?? null)) }}" alt="" width="105"
                                          height="44" />
                                      <img class="brand-logo-light"
                                          src="{{ sc_file(sc_store('logo', $storeId ?? null)) }}" alt="" width="106"
                                          height="44" /></a>
                              </div>
                          </div>
                              ...
                              <ul class="rd-navbar-nav">
                                  @if (sc_config('link_home_page', null, 1))
                                      <li class="rd-nav-item active"><a class="rd-nav-link"
                                              href="{{ sc_route('home') }}">{{ sc_language_render('front.home') }}</a>
                                      </li>
                                  @endif
                                  @if (sc_config('link_shop_page', null, 1))
                                      <li class="rd-nav-item"><a class="rd-nav-link"
                                              href="{{ sc_route('shop') }}">{{ sc_language_render('front.shop') }}</a>
                                      </li>
                                  @endif
                                  ...
                                  @if (sc_config('link_account', null, 1))
                                      @guest
                                          <li class="rd-nav-item"><a class="rd-nav-link" href="#"><i
                                                      class="fa fa-lock"></i>
                                                  {{ sc_language_render('front.account') }}</a>
                                      ...
                                      @else
                                          <li class="rd-nav-item"><a class="rd-nav-link" href="#"><i
                                              ...
                                              <ul class="rd-menu rd-navbar-dropdown">
                                                  ...
                                                  <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                          href="{{ sc_route('logout') }}" rel="nofollow" onclick="event.preventDefault();
